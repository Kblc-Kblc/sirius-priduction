...
let slider_about = new Swiper('.reviews__content', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let slider_video = new Swiper('.video-slider__content', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let events_gallery = new Swiper('.event-gallery__row', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.event-gallery-arrows-right',
		prevEl: '.event-gallery-arrows-left',
	},
